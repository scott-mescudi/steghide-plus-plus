...
def extract_data_with_steghide(image_path, passphrase):
    ...
    try:
        # Execute the command
        result = subprocess.run(command, capture_output=True, text=True, check=True)
        extracted_file_location = result.stdout.split("Extracted data to ")[-1].strip()
        # Print the extracted file location in green color
        print(Fore.GREEN + "Extracted document location:", extracted_file_location)
        print(Fore.GREEN + "Success!")
    except subprocess.CalledProcessError as e:
        # If the command fails, print the error in red color
        print(Fore.RED + "Error:", e)
...
def install_or_update_steghide():
    try:
        ...
        if not os.path.exists("steghide.exe"):
            print(Fore.YELLOW + "Steghide is not installed. Installing...")
            subprocess.run(["choco", "install", "steghide"], capture_output=True, text=True, check=True)
...
def install_or_update_tesseract():
    try:
        ...
        if not os.path.exists("tesseract.exe"):
            ...
            subprocess.run(["choco", "install", "tesseract"], capture_output=True, text=True, check=True)
            print(Fore.GREEN + "Tesseract-OCR installed successfully.")
        else:
            print(Fore.GREEN + "Tesseract is already installed")
    except Exception as e:
        # Print any errors in red color
        print(Fore.RED + "An error occurred:", e)
...
ssssss   s:::::s       t:::::t    tttttte:::::::e           g::::::g    g:::::g h:::::h     h:::::hi::::::id::::::ddddd::::::dde::::::::e                 +:::::+              +:::::+       
s:::::ssss::::::s      t::::::tttt:::::te::::::::e          g:::::::ggggg:::::g h:::::h     h:::::hi::::::i d:::::::::::::::::d e::::::::eeeeeeee                                            
s::::::::::::::s       tt::::::::::::::t e::::::::eeeeeeee   g::::::::::::::::g h:::::h     h:::::hi::::::i  d:::::::::ddd::::d  ee:::::::::::::e                                            
 s:::::::::::ss          tt:::::::::::tt  ee:::::::::::::e    gg::::::::::::::g h:::::h     h:::::hi::::::i   ddddddddd   ddddd    eeeeeeeeeeeeee                                            
  sssssssssss              ttttttttttt      eeeeeeeeeeeeee      gggggggg::::::g hhhhhhh     hhhhhhhiiiiiiii                g:::::g                                                                                                              
                                                                        g:::::g                                                                                                              
                                                            gggggg      g:::::g                                                                                                              
                                                            g:::::gg   gg:::::g                                                                                                              
                                                             g::::::ggg:::::::g                                                                                                              
